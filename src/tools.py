"""Narzędzia dla agentów (Web Search, URL, Current Date)."""
...
class CurrentDateTool(BaseTool):
    ...
    description: str = "Zwraca aktualną datę YYYY-MM-DD."
...
class URLReaderTool(BaseTool):
    name: str = "url_reader"
    description: str = "Czyta treść ze strony URL."

    def _run(self, url: str) -> str:
        try:
            loader = WebBaseLoader(url)
            docs = loader.load()
            return docs[0].page_content[:1000] if docs else "Nie udało się odczytać."
